...
In this instance, the Massive Damage Sm combo increases the multiplier to 4.4.  
...
In this instance, the Massive Damage UP Sm combo would increase the multiplier to 4.4.  
...
In this instance, the Resistant UP L combo decreases the multiplier to 0.14.  
  
*This does **not** affect the Insanely Tough ability, only Resistant.*
...
Note that this is *better* than a Sm Attack Power when strengthened, though still has the drawback of
...
*Units with no critical hit ability do not gain critical hits from this combo.*
...
The second charge of the cannon will however restart from 0% and require the full 50s to be ready.
...
*Contrary to Cat Cannon Damage upgrades, this combo will not increase the recharge time.*
...
*This combo is called "Worker Cat Max UP" in-game.*
...
When using multiple combos, percentages are added together *before* their multiplication. This means
...
This does stack with the Double Money ability.
...
The effect of Study does stack with the Cat Jobs item.  
