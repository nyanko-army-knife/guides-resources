...
This is the best cannon when it comes to gaining stage distance and pushing back enemies, and is the second best cannon overall. Its only downside compared to the regular cannon is that it might sometimes knock back the frontline only and cause your units to die to the enemy backline, though this rarely happens. Despite this, Breakerblast is far easier to time due to it having a much shorter delay, and it not being affected by
stage width.
